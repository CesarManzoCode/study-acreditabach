...
const AREA5_EXTRA2 = {
  ...
  "5.1.2": {
    ...
    quiz: [
      ...
      { q: "El plasma se diferencia del gas porque:", options: ["Está ionizado y conduce la electricidad", "Tiene forma definida", "Es más frío"], correct: 0, explanation: "La ionización, con electrones libres, le da propiedades eléctricas y magnéticas distintas." }
    ]
  },
  ...
  "5.1.4": {
    ...
    quiz: [
      ...
      { q: "Una sustancia funde a 27 °C. ¿Cuál es esa temperatura en kelvin?", options: ["300.15 K", "246.15 K", "27 K"], correct: 0, explanation: "K = °C + 273.15 = 27 + 273.15 = 300.15 K." },
      { q: "¿A cuántos grados Celsius equivalen 373.15 K?", options: ["100 °C", "273 °C", "0 °C"], correct: 0, explanation: "373.15 − 273.15 = 100 °C, el punto de ebullición del agua al nivel del mar." },
      { q: "El cero absoluto corresponde a:", options: ["−273.15 °C", "0 °C", "−100 °C"], correct: 0, explanation: "Es el origen de la escala Kelvin, la temperatura más baja posible." }
    ]
  },
  ...
  "5.2.1": {
    flashcards: [
      ...
      { front: "¿Por qué el cielo se ve azul?", back: "Por la dispersión de Rayleigh: la atmósfera dispersa más la luz de longitudes de onda cortas (azul) que las largas (rojo)." }
    ],
    quiz: [
  ...
  "5.2.2": {
    ...
    flashcards: [
      ...
      { front: "¿Qué es el equilibrio térmico?", back: "El estado al que llegan dos cuerpos en contacto cuando alcanzan la misma temperatura: el calor cedido por el más caliente es igual al absorbido por el más frío." }
    ],
    quiz: [
  ...
  "5.2.3": {
    ...
    quiz: [
      { q: "La energía almacenada en los enlaces de los alimentos es:", options: ["Química", "Cinética", "Nuclear"], correct: 0, explanation: "Se libera al romperse los enlaces durante la digestión y la respiración celular." },
      { q: "¿Cuál de estas fuentes de energía NO es renovable?", options: ["El gas natural", "La energía eólica", "La energía geotérmica"], correct: 0, explanation: "El gas natural es un combustible fósil cuya formación tarda millones de años." },
      { q: "Un foco incandescente convierte la mayor parte de la energía eléctrica en:", options: ["Calor, lo que explica su baja eficiencia", "Luz visible", "Energía química"], correct: 0, explanation: "Solo un porcentaje pequeño se transforma en luz; el resto se disipa como calor." },
      { q: "Una presa hidroeléctrica transforma la energía en el siguiente orden:", options: ["Potencial gravitatoria → cinética → eléctrica", "Química → térmica → eléctrica", "Nuclear → cinética → eléctrica"], correct: 0, explanation: "El agua embalsada cae, mueve las turbinas y el generador produce electricidad." },
      { q: "Una motocicleta en movimiento con el tanque lleno posee:", options: ["Energía cinética y energía química", "Solo energía cinética", "Solo energía potencial"], correct: 0, explanation: "El movimiento aporta energía cinética y el combustible, energía química almacenada." }
    ]
  },
  ...
  "5.3.2": {
    flashcards: [
      ...
      { front: "¿Qué caracteriza al desierto y al matorral xerófilo?", back: "Precipitación menor a 250 mm anuales, gran oscilación térmica entre día y noche y organismos con adaptaciones para retener agua, como tallos suculentos y hojas transformadas en espinas." }
    ],
    quiz: [
      ...
      { q: "Las espinas de los cactus son hojas modificadas que sirven para:", options: ["Reducir la pérdida de agua y disuadir a los herbívoros", "Captar más luz solar", "Almacenar semillas"], correct: 0, explanation: "Al reducir la superficie foliar disminuye la transpiración." },
      { q: "El bosque de coníferas o taiga se distingue por:", options: ["Árboles de hoja perenne en forma de aguja adaptados al frío", "Pastizales sin árboles", "Alta salinidad del suelo"], correct: 0, explanation: "La forma de aguja reduce la pérdida de agua y soporta el peso de la nieve." }
    ]
  },
  ...
  "5.3.3": {
    ...
    quiz: [
      ...
      { q: "La bioacumulación de contaminantes afecta más a:", options: ["Los consumidores de los niveles tróficos superiores", "Los productores", "Los descomponedores"], correct: 0, explanation: "Las sustancias persistentes se concentran al ascender por la cadena alimentaria." }
    ]
  },

  "5.3.4": {
    flashcards: [
      { front: "¿Qué es la fijación del nitrógeno?", back: "La conversión del N₂ atmosférico en compuestos asimilables (amonio, nitratos) realizada por bacterias, muchas de ellas en las raíces de las leguminosas." },
      ...
      { front: "¿Qué diferencia tiene el ciclo del fósforo respecto de los demás?", back: "No tiene fase gaseosa apreciable: circula entre rocas, suelo, agua y organismos, por lo que es un ciclo lento y el fósforo suele ser el nutriente limitante." }
    ],
    quiz: [
      { q: "El proceso por el que las bacterias convierten el nitrógeno atmosférico en compuestos asimilables se llama:", options: ["Fijación del nitrógeno", "Nitrificación", "Desnitrificación"], correct: 0, explanation: "Es el paso que permite que el N₂ ingrese a la cadena alimentaria." },
      ...
      { q: "El ciclo del fósforo se distingue porque:", options: ["Carece de una fase gaseosa importante y es muy lento", "Ocurre principalmente en la atmósfera", "No involucra a los seres vivos"], correct: 0, explanation: "Depende de la erosión de las rocas, lo que lo vuelve el nutriente limitante en muchos ecosistemas." },
      { q: "La eutrofización de un lago es causada principalmente por:", options: ["El exceso de nitrógeno y fósforo procedente de fertilizantes y aguas residuales", "La falta de nutrientes", "El descenso de la temperatura"], correct: 0, explanation: "El exceso de nutrientes dispara el crecimiento de algas y agota el oxígeno del agua." },
      { q: "En el ciclo del agua, el paso del vapor atmosférico a estado líquido se denomina:", options: ["Condensación", "Evaporación", "Infiltración"], correct: 0, explanation: "Es el proceso que forma las nubes y precede a la precipitación." }
    ]
  },
  ...
  "5.3.6": {
    ...
    quiz: [
      { q: "La captura de carbono por un bosque es un servicio ambiental de:", options: ["Regulación", "Provisión", "Cultural"], correct: 0, explanation: "Regula la composición atmosférica y el clima." },
      ...
      { q: "La desaparición de polinizadores afectaría principalmente:", options: ["La producción de una gran parte de los cultivos alimentarios", "La temperatura del planeta", "La salinidad de los océanos"], correct: 0, explanation: "La mayoría de los cultivos requiere polinización animal para fructificar." }
    ]
  },
  ...
  "5.4.2": {
    flashcards: [
      { front: "¿Cómo se reconoce una reacción de sustitución simple y una doble?", back: "**Simple**: A + BC → AC + B (un elemento desplaza a otro). **Doble**: AB + CD → AD + CB (dos compuestos intercambian sus partes)." },
      { front: "¿Qué es una reacción exotérmica y una endotérmica?", back: "La **exotérmica** libera energía al entorno (combustión); la **endotérmica** la absorbe (fotosíntesis, disolución de nitrato de amonio en agua fría)." },
      { front: "¿Qué es una reacción de neutralización?", back: "Un caso de doble sustitución entre un ácido y una base que produce sal y agua: HCl + NaOH → NaCl + H₂O." }
    ],
    quiz: [
      { q: "La reacción Zn + 2HCl → ZnCl₂ + H₂ es de tipo:", options: ["Sustitución simple", "Síntesis", "Descomposición"], correct: 0, explanation: "El zinc desplaza al hidrógeno del ácido." },
      ...
      { q: "La combustión de un hidrocarburo produce siempre:", options: ["Dióxido de carbono y agua", "Hidrógeno y nitrógeno", "Sal y agua"], correct: 0, explanation: "En una combustión completa con oxígeno suficiente esos son los productos." },
      { q: "La reacción entre HCl y NaOH que forma NaCl y H₂O se clasifica como:", options: ["Neutralización (doble sustitución)", "Descomposición", "Sustitución simple"], correct: 0, explanation: "Un ácido y una base intercambian sus iones para dar sal y agua." },
      { q: "Una reacción que libera calor al entorno se llama:", options: ["Exotérmica", "Endotérmica", "Isotérmica"], correct: 0, explanation: "La energía de los productos es menor que la de los reactivos." }
    ]
  },
  ...
  "5.4.3": {
    ...
    flashcards: [
      ...
      { front: "¿Qué son las radiaciones alfa, beta y gamma?", back: "**Alfa**: núcleos de helio, poco penetrantes (los detiene una hoja de papel). **Beta**: electrones, detenidos por aluminio. **Gamma**: ondas electromagnéticas de altísima energía, requieren plomo o concreto." }
    ],
    quiz: [
      ...
      { q: "Una muestra radiactiva de 80 g tiene una vida media de 5 años. ¿Cuánta masa radiactiva queda después de 15 años?", options: ["10 g", "20 g", "40 g"], correct: 0, explanation: "Tres vidas medias: 80 → 40 → 20 → 10 g." },
      ...
      { q: "La radiación más penetrante y que requiere blindaje de plomo o concreto es la:", options: ["Gamma", "Alfa", "Beta"], correct: 0, explanation: "Al ser radiación electromagnética de alta energía atraviesa casi todos los materiales." },
      { q: "Un isótopo con vida media de 8 días partió de 200 g. ¿Cuánto queda tras 24 días?", options: ["25 g", "50 g", "12.5 g"], correct: 0, explanation: "Tres vidas medias: 200 → 100 → 50 → 25 g." }
    ]
  },
  ...
  "5.5.4": {
    flashcards: [
      ...
      { front: "¿Qué pasa en un tiro vertical hacia arriba?", back: "El objeto sube frenando a razón de 9.8 m/s cada segundo, se detiene un instante en el punto más alto y baja con el mismo tiempo y la misma rapidez con que subió." }
    ],
    quiz: [
      ...
      { q: "Un objeto se lanza verticalmente hacia arriba a 19.6 m/s. ¿Cuánto tarda en alcanzar su altura máxima? (g = 9.8 m/s²)", options: ["2 s", "1 s", "4 s"], correct: 0, explanation: "t = v/g = 19.6/9.8 = 2 segundos." },
  ...
  "5.6.3": {
    flashcards: [
      ...
      { front: "¿Qué tipos de fermentación existen?", back: "**Láctica** (músculo con poco oxígeno, yogur) y **alcohólica** (levaduras, que producen etanol y CO₂: pan, cerveza, vino)." }
    ],
    quiz: [
      ...
      { q: "La fermentación alcohólica realizada por las levaduras produce:", options: ["Etanol y dióxido de carbono", "Ácido láctico", "Agua y oxígeno"], correct: 0, explanation: "El CO₂ hace crecer la masa del pan y el etanol da origen a las bebidas fermentadas." }
    ]
  },
  ...
  "5.7.2": {
    ...
    quiz: [
      ...
      { q: "El síndrome de Down se debe a:", options: ["Una trisomía del cromosoma 21", "La ausencia de un cromosoma X", "Una mutación en el cromosoma Y"], correct: 0, explanation: "Hay tres copias del cromosoma 21 en lugar de dos." },
  ...
  "5.7.4": {
    flashcards: [
      ...
      { front: "¿Qué es la teoría sintética o neodarwinismo?", back: "La integración del darwinismo con la genética mendeliana y la genética de poblaciones: la mutación y la recombinación aportan la variación y la selección natural actúa sobre ella." }
    ],
    quiz: [
      ...
      { q: "La teoría sintética de la evolución integró el darwinismo con:", options: ["La genética mendeliana y la genética de poblaciones", "La teoría celular", "La generación espontánea"], correct: 0, explanation: "Explicó el mecanismo hereditario que a Darwin le faltaba." },
  ...
  "5.7.5": {
    ...
    quiz: [
      ...
      { q: "La especiación alopátrica se produce por:", options: ["El aislamiento geográfico de dos poblaciones", "Una mutación única e instantánea", "La domesticación"], correct: 0, explanation: "Al interrumpirse el flujo genético, las poblaciones divergen." },
      { q: "El apéndice y los huesos de la pelvis en las ballenas son ejemplos de estructuras:", options: ["Vestigiales", "Análogas", "Adquiridas"], correct: 0, explanation: "Son restos de órganos funcionales en los ancestros." },
