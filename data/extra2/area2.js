...
const AREA2_EXTRA2 = {
  "2.1.1": {
    ...
    flashcards: [
      ...
      { front: "¿Qué es el derecho al olvido?", back: "La posibilidad de solicitar que se retire o deje de indexarse información personal en buscadores cuando ya es obsoleta, inexacta o irrelevante." }
    ],
    quiz: [
  ...
  "2.1.2": {
    flashcards: [
      ...
      { front: "¿Qué son las licencias Creative Commons?", back: "Licencias para obras (textos, fotos, música) que permiten al autor liberar su uso con condiciones: atribución (BY), sin obras derivadas (ND), no comercial (NC) o compartir igual (SA)." }
    ],
    quiz: [
      ...
      { q: "¿Cuál es la característica esencial del software de código abierto?", options: ["El código fuente está disponible para revisarlo y modificarlo", "Siempre es gratuito", "Solo funciona en Linux"], correct: 0, explanation: "Lo definitorio es el acceso al código; la gratuidad es frecuente pero no obligatoria." },
      { q: "Una fotografía con licencia CC BY-NC se puede:", options: ["Usar y adaptar dando crédito al autor, pero sin fines comerciales", "Vender libremente sin dar crédito", "Usar solo con permiso escrito del autor"], correct: 0, explanation: "BY exige atribución y NC prohíbe el uso comercial." },
      { q: "Instalar una copia de un programa comercial en 20 computadoras teniendo una sola licencia constituye:", options: ["Piratería o uso no autorizado del software", "Uso de software libre", "Una práctica permitida en escuelas"], correct: 0, explanation: "La licencia define cuántas instalaciones autoriza; excederlas viola el contrato y la ley de derechos de autor." },
      { q: "El software propietario se caracteriza porque:", options: ["El código fuente es cerrado y el uso está limitado por la licencia del fabricante", "Cualquiera puede modificarlo y redistribuirlo", "Nunca tiene costo"], correct: 0, explanation: "El fabricante conserva los derechos y define las condiciones de uso." }
    ]
  },

  "2.1.3": {
    flashcards: [
      { front: "¿Qué son los servicios en la nube SaaS, PaaS e IaaS?", back: "**SaaS**: software listo para usar (correo web, suites de oficina en línea). **PaaS**: plataforma para desarrollar aplicaciones. **IaaS**: infraestructura (servidores y almacenamiento) que se renta." },
      { front: "¿Qué es el gobierno digital o e-gobierno?", back: "El conjunto de servicios que el Estado ofrece en línea: citas, pagos de impuestos, actas, denuncias y consulta de trámites, sin acudir a una oficina." },
      { front: "¿Qué es la banca en línea y qué riesgo principal tiene?", back: "Permite hacer operaciones bancarias por internet. Su riesgo principal es la suplantación (phishing) de la página o la aplicación del banco." }
    ],
    quiz: [
      ...
      { q: "Una suite de ofimática que se usa desde el navegador, sin instalar nada, corresponde al modelo:", options: ["SaaS (software como servicio)", "IaaS (infraestructura como servicio)", "PaaS (plataforma como servicio)"], correct: 0, explanation: "El usuario consume el software terminado; el proveedor se encarga de todo lo demás." },
      { q: "Sacar una cita para el pasaporte desde el portal del gobierno es un ejemplo de:", options: ["Servicio de gobierno digital", "Comercio electrónico", "Red social"], correct: 0, explanation: "Es un trámite público ofrecido en línea por una dependencia del Estado." },
  ...
  "2.1.4": {
    ...
    quiz: [
      ...
      { q: "El acoso reiterado a una persona por medios digitales, con burlas y amenazas, se conoce como:", options: ["Ciberbullying", "Grooming", "Sexting"], correct: 0, explanation: "Es hostigamiento entre pares mediante medios digitales." },
  ...
  "2.2.1": {
    ...
    quiz: [
      ...
      { q: "Una comunidad rural sin cobertura de internet padece principalmente:", options: ["Brecha digital de acceso", "Exceso de identidad digital", "Obsolescencia programada"], correct: 0, explanation: "La primera dimensión de la brecha digital es la posibilidad misma de conectarse." },
      { q: "El anonimato en el ciberespacio tiene como principal riesgo:", options: ["Facilitar conductas de agresión o engaño sin consecuencias inmediatas", "Impedir el uso de buscadores", "Reducir la velocidad de la red"], correct: 0, explanation: "Al diluirse la responsabilidad personal, aumentan conductas que no se darían cara a cara." },
      { q: "La expresión «nativos digitales» se refiere a:", options: ["Las generaciones que crecieron rodeadas de tecnologías digitales", "Los programadores profesionales", "Los usuarios de software libre"], correct: 0, explanation: "Describe a quienes se socializaron con estas tecnologías desde la infancia, no a un nivel de pericia garantizado." }
    ]
  },
  ...
  "2.2.2": {
    flashcards: [
      ...
      { front: "¿Qué es el aprendizaje ubicuo?", back: "El que puede ocurrir en cualquier momento y lugar gracias a los dispositivos conectados, dentro o fuera del aula." },
      { front: "¿Qué son los entornos virtuales de aprendizaje (EVA)?", back: "Plataformas que organizan materiales, actividades, entregas y evaluación de un curso en línea, como los sistemas de gestión del aprendizaje (LMS)." }
    ],
    quiz: [
      ...
      { q: "Un curso con videos, foros, tareas y calificaciones dentro de una misma plataforma es un ejemplo de:", options: ["Entorno virtual de aprendizaje", "Hoja de cálculo colaborativa", "Motor de búsqueda"], correct: 0, explanation: "Integra todos los elementos del proceso educativo en un solo espacio digital." },
      { q: "Que un estudiante repase una lección en el transporte, desde el celular, ilustra el concepto de:", options: ["Aprendizaje ubicuo", "Aula invertida", "Evaluación diagnóstica"], correct: 0, explanation: "El aprendizaje deja de estar atado a un lugar y a un horario fijo." },
      { q: "En el modelo de aula invertida, la tecnología se usa para:", options: ["Revisar el contenido en casa y dedicar la clase a practicar y resolver dudas", "Sustituir por completo al docente", "Aplicar exámenes en línea únicamente"], correct: 0, explanation: "Se invierte el orden clásico: la exposición se ve antes y el tiempo presencial se dedica a la práctica." },
      { q: "El principal riesgo de usar TICCAD sin acompañamiento pedagógico es:", options: ["Usar herramientas nuevas para repetir prácticas de enseñanza pasivas", "Que el internet se vuelva más lento", "Que los equipos se descompongan"], correct: 0, explanation: "Sin un cambio de enfoque, la tecnología solo digitaliza la clase expositiva de siempre." }
    ]
  },
  ...
  "2.2.3": {
    ...
    flashcards: [
      ...
      { front: "¿Cómo se elige la herramienta digital adecuada?", back: "Partiendo de la tarea, no de la moda: definir el propósito (comunicar, organizar, analizar, crear), el público y los recursos disponibles, y solo entonces elegir el programa." }
    ],
    quiz: [
      { q: "Para organizar las tareas de un equipo con fechas y responsables, la herramienta más adecuada es:", options: ["Un gestor de proyectos con tableros o listas", "Un editor de imágenes", "Un reproductor multimedia"], correct: 0, explanation: "Los gestores de proyectos están diseñados para asignar, dar seguimiento y calendarizar actividades." },
      { q: "Para analizar 500 respuestas numéricas de una encuesta, lo más adecuado es usar:", options: ["Una hoja de cálculo", "Un procesador de texto", "Un software de presentaciones"], correct: 0, explanation: "Las hojas de cálculo permiten filtrar, resumir y graficar grandes conjuntos de datos." },
      ...
      { q: "Un mapa mental digital es especialmente útil para:", options: ["Organizar ideas y mostrar relaciones jerárquicas entre conceptos", "Calcular promedios", "Editar audio"], correct: 0, explanation: "Su fuerza está en representar visualmente cómo se conectan las ideas." },
      { q: "Antes de elegir una herramienta digital para un proyecto escolar conviene definir primero:", options: ["El propósito y el público del producto", "El color de la interfaz", "La marca del dispositivo"], correct: 0, explanation: "La herramienta se elige en función de la tarea; hacerlo al revés lleva a resultados forzados." }
    ]
  },
  ...
  "2.2.4": {
    ...
    flashcards: [
      ...
      { front: "¿Qué es una base de datos académica?", back: "Un repositorio de artículos científicos revisados por pares (como SciELO, Redalyc o Google Académico), más confiable que una búsqueda web general." }
    ],
    quiz: [
      { q: "Para buscar la frase exacta «cambio climático en México» en un buscador conviene:", options: ["Escribirla entre comillas", "Escribirla en mayúsculas", "Agregar signos de admiración"], correct: 0, explanation: "Las comillas obligan al buscador a encontrar esa secuencia literal de palabras." },
      { q: "La búsqueda «energía solar NOT fotovoltaica» devuelve resultados que:", options: ["Hablan de energía solar pero excluyen la palabra fotovoltaica", "Contienen ambas palabras", "Contienen cualquiera de las dos"], correct: 0, explanation: "NOT (o el signo menos) excluye el término que le sigue." },
      { q: "¿Cuál de estas fuentes es más confiable para un trabajo académico?", options: ["Un artículo de una revista arbitrada con autor y referencias", "Una publicación anónima en una red social", "Un blog personal sin fecha ni citas"], correct: 0, explanation: "La revisión por pares y las referencias verificables son los mejores indicadores de confiabilidad." },
      { q: "El dominio .gob.mx en una página indica que:", options: ["Pertenece a una dependencia del gobierno mexicano", "Es una empresa privada", "Es una universidad extranjera"], correct: 0, explanation: "Los dominios ayudan a identificar la naturaleza institucional del sitio." },
      { q: "Al usar información de internet en un trabajo, lo correcto es:", options: ["Citar la fuente con autor, título, sitio y fecha de consulta", "Copiarla sin cambios porque es pública", "Parafrasearla sin mencionar el origen"], correct: 0, explanation: "Omitir la fuente, aun parafraseando, constituye plagio." }
    ]
  },
  ...
  "2.3.1": {
    ...
    quiz: [
      ...
      { q: "El gráfico más adecuado para mostrar la proporción que representa cada rubro dentro de un total es:", options: ["De pastel o circular", "De líneas", "De dispersión"], correct: 0, explanation: "El gráfico circular está pensado para partes de un todo; el de líneas muestra evolución en el tiempo." }
    ]
  },

  "2.3.2": {
    flashcards: [
      { front: "¿Para qué sirven los estilos de título en un procesador de texto?", back: "Además de dar formato uniforme, permiten generar automáticamente la tabla de contenido y navegar el documento por su estructura." },
      { front: "¿Qué es el control de cambios?", back: "Una función que marca cada inserción, borrado o comentario indicando quién lo hizo, para que el autor acepte o rechace las modificaciones." },
    ...
    quiz: [
      { q: "Para generar automáticamente el índice de un trabajo largo es necesario:", options: ["Haber aplicado estilos de título a los apartados", "Escribir el índice a mano al final", "Usar tabulaciones y puntos"], correct: 0, explanation: "La tabla de contenido se construye a partir de los niveles de título aplicados." },
      ...
      { q: "La función de combinar correspondencia sirve para:", options: ["Generar muchos documentos personalizados a partir de una lista de datos", "Corregir la ortografía", "Insertar imágenes"], correct: 0, explanation: "Es la herramienta clásica para cartas, constancias o etiquetas con datos variables." },
      { q: "El control de cambios resulta especialmente útil cuando:", options: ["Varias personas revisan y sugieren correcciones a un mismo documento", "Se quiere reducir el tamaño del archivo", "Se necesita imprimir a doble cara"], correct: 0, explanation: "Permite ver y decidir sobre cada modificación propuesta sin perder el original." },
      { q: "Los encabezados y pies de página sirven para:", options: ["Repetir información como el título o la numeración en todas las páginas", "Cambiar el interlineado", "Ordenar alfabéticamente una tabla"], correct: 0, explanation: "Su contenido se replica automáticamente en todo el documento o sección." }
    ]
  },

  "2.3.3": {
    flashcards: [
      { front: "¿Qué es el patrón de diapositivas?", back: "La plantilla maestra donde se definen tipografías, colores y posiciones. Al cambiarla, se actualizan de golpe todas las diapositivas de la presentación." },
      { front: "Regla práctica para el texto de una diapositiva", back: "Poco texto y de buen tamaño: ideas en frases cortas, no párrafos. La diapositiva apoya a quien expone; no es el documento que se lee en voz alta." },
      { front: "¿Qué diferencia hay entre transición y animación?", back: "La **transición** es el efecto al pasar de una diapositiva a otra; la **animación** afecta a los elementos dentro de una misma diapositiva." }
    ],
    quiz: [
      { q: "Para cambiar la tipografía de toda una presentación de una sola vez conviene editar:", options: ["El patrón de diapositivas", "Cada diapositiva por separado", "Las notas del orador"], correct: 0, explanation: "El patrón define el formato heredado por todas las diapositivas." },
      { q: "El efecto que ocurre al pasar de una diapositiva a la siguiente se llama:", options: ["Transición", "Animación", "Hipervínculo"], correct: 0, explanation: "Las animaciones aplican a objetos; las transiciones, al cambio entre diapositivas." },
      { q: "¿Cuál es el principal error de diseño en una presentación?", options: ["Saturar la diapositiva con párrafos completos y leerlos", "Usar imágenes de apoyo", "Numerar las diapositivas"], correct: 0, explanation: "El público lee o escucha, no ambas cosas: el texto denso anula la exposición." },
      { q: "Las notas del orador sirven para:", options: ["Escribir apuntes que solo ve quien expone", "Agregar subtítulos automáticos", "Cambiar el color de fondo"], correct: 0, explanation: "Se muestran en la vista del presentador, no en la proyección." },
  ...
  "2.3.5": {
    ...
    flashcards: [
      ...
      { front: "¿Qué diferencia hay entre realidad virtual y realidad aumentada?", back: "La **virtual** sustituye por completo el entorno con uno simulado; la **aumentada** superpone información digital sobre el entorno real." }
    ],
    quiz: [
      ...
      { q: "Una aplicación que muestra información sobre un edificio al enfocarlo con la cámara usa:", options: ["Realidad aumentada", "Realidad virtual", "Impresión 3D"], correct: 0, explanation: "Añade capas digitales sobre lo que se ve en el mundo real." },
      { q: "En medicina, la impresión 3D se aplica principalmente para:", options: ["Fabricar prótesis y modelos anatómicos personalizados", "Almacenar expedientes clínicos", "Enviar recetas por correo"], correct: 0, explanation: "Permite producir piezas a la medida de cada paciente." },
      ...
      { q: "La automatización con robots en la industria tiene como consecuencia social principal:", options: ["La transformación de los empleos y la necesidad de nuevas competencias", "La desaparición del internet", "El aumento del precio del software libre"], correct: 0, explanation: "Cambia el tipo de tareas humanas requeridas más que eliminar el trabajo por completo." }
    ]
  },
  ...
  "2.4.1": {
    ...
    quiz: [
      ...
      { q: "¿Qué es un pseudocódigo?", options: ["Una descripción del algoritmo en lenguaje natural estructurado, previa a programarlo", "Un lenguaje de programación compilado", "Un tipo de virus informático"], correct: 0, explanation: "Sirve para razonar la lógica sin preocuparse por la sintaxis de un lenguaje real." },
      ...
      { q: "Un ciclo infinito ocurre cuando:", options: ["La condición de salida nunca llega a ser falsa", "El programa no tiene variables", "Se usan demasiados condicionales"], correct: 0, explanation: "Si nada modifica la condición dentro del ciclo, la repetición no termina nunca." }
    ]
  },
  ...
  "2.4.2": {
    ...
    quiz: [
      ...
      { q: "Que un algoritmo sea finito significa que:", options: ["Termina después de un número determinado de pasos", "Usa pocas variables", "Solo funciona con números pequeños"], correct: 0, explanation: "Un procedimiento que nunca termina no resuelve el problema." },
      ...
      { q: "Probar el algoritmo con distintos casos para detectar fallas se llama:", options: ["Depuración o prueba de escritorio", "Compilación", "Documentación"], correct: 0, explanation: "La prueba de escritorio recorre el algoritmo paso a paso con datos concretos." },
      { q: "Que un algoritmo sea preciso implica que:", options: ["Cada paso está redactado sin ambigüedad y se puede ejecutar de una sola forma", "Está escrito en inglés", "Es el más corto posible"], correct: 0, explanation: "Si un paso admite varias interpretaciones, el resultado deja de ser predecible." }
    ]
  },
  ...
  "2.4.3": {
    ...
    flashcards: [
      ...
      { front: "¿Qué es la generalización en el pensamiento algorítmico?", back: "Adaptar una solución ya conocida a un problema nuevo con la misma estructura, en vez de empezar desde cero." }
    ],
    quiz: [
      { q: "Dividir un problema grande en partes más pequeñas y manejables se llama:", options: ["Descomposición", "Abstracción", "Iteración"], correct: 0, explanation: "Es el primer pilar del pensamiento computacional: atacar por partes." },
      { q: "Un mapa del metro que no respeta las distancias reales pero muestra bien el orden de las estaciones es un ejemplo de:", options: ["Abstracción", "Depuración", "Descomposición"], correct: 0, explanation: "Se conservan solo los datos relevantes para la tarea de orientarse." },
      { q: "Notar que varios problemas distintos se resuelven con el mismo procedimiento es:", options: ["Reconocimiento de patrones", "Codificación", "Compilación"], correct: 0, explanation: "Identificar regularidades permite reutilizar soluciones." },
      ...
      { q: "La ventaja de reutilizar una solución conocida en un problema nuevo se conoce como:", options: ["Generalización", "Anidación", "Redundancia"], correct: 0, explanation: "Se aprovecha la estructura común entre problemas distintos." }
    ]
  },
