const AREA5_TOPICS = [
  ...
  },
  {
    ...
    note: "Hay 4 leyes de la termodinámica. La **ley cero** dice que si dos cuerpos están en equilibrio térmico con un tercero, están en equilibrio entre sí (ej. dos bloques de hielo que se tocan alcanzan la misma temperatura). La **primera ley** es la conservación de la energía: la energía no se crea ni se destruye, solo se transforma (ej. la energía química de la gasolina se transforma en movimiento en un motor). La **segunda ley** dice que el calor fluye espontáneamente de lo caliente a lo frío, nunca al revés por sí solo, y que **en un sistema aislado la entropía (desorden) nunca disminuye**. Precisión que evita un error frecuente: no es que «la entropía siempre aumente» en todas partes. En un proceso reversible ideal se mantiene constante, y la entropía de una parte del sistema **sí puede bajar** —un refrigerador enfría su interior, un ser vivo se organiza— a costa de aumentarla más en el entorno. Lo que nunca baja es el total del sistema aislado. La **tercera ley** dice que no se puede alcanzar el cero absoluto de temperatura (−273.15 °C o 0 K).",
    flashcards: [
  ...
  },
  {
    ...
    note: "Los ciclos biogeoquímicos son el recorrido de los elementos entre los seres vivos y el ambiente. La orientación de la guía pide **identificar las sustancias** que aparecen en el ciclo del carbono y en el del azufre, así que apréndete las fórmulas, no solo el relato.\n\n**Ciclo del carbono — sustancias que hay que reconocer:**\n· **CO₂** (dióxido de carbono): en la atmósfera y disuelto en el agua. Lo toman las plantas en la fotosíntesis y lo devuelven la respiración, la descomposición y la combustión.\n· **Glucosa, C₆H₁₂O₆**, y en general la materia orgánica: la forma en que el carbono queda «guardado» en los seres vivos.\n· **CH₄** (metano): lo producen bacterias en ambientes sin oxígeno —pantanos, rumiantes, rellenos sanitarios—.\n· **Carbonatos y bicarbonatos (CO₃²⁻, HCO₃⁻)** en el océano, y **CaCO₃** (carbonato de calcio) en conchas y rocas calizas: el almacén de largo plazo.\n· **Combustibles fósiles** (carbón, petróleo, gas): carbono retirado del ciclo durante millones de años y devuelto de golpe al quemarse.\n\n**Ciclo del azufre — sustancias que hay que reconocer:**\n· **H₂S** (sulfuro de hidrógeno): lo liberan los volcanes y la descomposición anaerobia; huele a huevo podrido.\n· **SO₂** (dióxido de azufre): sale de los volcanes y, sobre todo, de la quema de combustibles fósiles.\n· **SO₄²⁻** (sulfato): la forma en que el azufre se disuelve en el suelo y el agua, y la única que las plantas pueden absorber.\n· **H₂SO₄** (ácido sulfúrico): se forma cuando el SO₂ se oxida en la atmósfera y reacciona con el agua; es lo que cae como **lluvia ácida**.\n· **Azufre orgánico**: incorporado a los aminoácidos **cisteína** y **metionina** de las proteínas.\n\nTambién existen los ciclos del nitrógeno, del agua y del fósforo. Truco: si el reactivo menciona CO₂, glucosa, metano o carbonatos, es el ciclo del carbono; si menciona H₂S, SO₂, sulfatos o lluvia ácida, es el del azufre.",
    flashcards: [
  ...
  },
  {
    ...
    note: "Los servicios ambientales (o ecosistémicos) son los beneficios que los ecosistemas dan a las personas. La clasificación estándar los divide en **cuatro** categorías, y **apoyo y regulación no son lo mismo**:\n\n**Aprovisionamiento**: los bienes tangibles que se extraen del ecosistema. Agua potable, alimentos, madera, fibras, plantas medicinales.\n\n**Regulación**: los procesos que controlan las condiciones del ambiente. Polinización, regulación del clima, captura de carbono, control de inundaciones y de plagas, purificación del aire y del agua.\n\n**Apoyo o soporte**: los procesos de base que hacen posibles todos los demás y que no se usan directamente. Formación del suelo, ciclo de nutrientes, producción primaria (la fotosíntesis), ciclo del agua.\n\n**Culturales**: los beneficios no materiales. Recreación, turismo, valor espiritual, estético y educativo (un parque para caminar, un bosque sagrado).\n\nTruco para distinguir apoyo de regulación: si el proceso **construye la base** del ecosistema y sus efectos se notan a largo plazo (formar suelo, reciclar nutrientes), es de **apoyo**; si **controla o amortigua** una condición concreta aquí y ahora (polinizar, filtrar agua, frenar una inundación), es de **regulación**.\n\nLa guía menciona explícitamente aprovisionamiento, apoyo y culturales, así que ten claros esos tres nombres; la regulación entra en cuanto el reactivo nombra las cuatro.",
    flashcards: [
      ...
      { front: "¿Qué tipo de servicio ambiental es la polinización o la regulación del clima?", back: "De **regulación**: controlan o amortiguan condiciones del ambiente. No confundir con los de **apoyo**, que son los procesos de base: formación del suelo, ciclo de nutrientes y producción primaria." }
    ],
    quiz: [
      ...
      { q: "La formación del suelo y el ciclo de los nutrientes son servicios ambientales:", options: ["De apoyo o soporte", "Culturales", "De aprovisionamiento"], correct: 0, explanation: "Son los procesos de base que hacen posibles a todos los demás servicios y que no se aprovechan de forma directa. Purificar el aire o polinizar, en cambio, son servicios de regulación." }
    ]
  },
  {
    id: "5.3.7",
  ...
  },
  {
    ...
    note: "Un choque (o colisión) ocurre cuando dos objetos interactúan con fuerza al encontrarse. En un choque **elástico**, los objetos rebotan y se separan después del impacto, y tanto el momento lineal como la energía cinética se conservan (ej. dos bolas de billar que chocan y cada una sigue su camino por separado). En un choque **inelástico**, los objetos se deforman, se pegan o pierden energía en forma de calor o sonido al chocar; el momento lineal se conserva pero la energía cinética no (ej. dos autos que chocan y quedan enganchados, o una plastilina que se pega a la pared). Dentro de los inelásticos conviene separar dos casos, porque el examen los ofrece como opciones distintas: el choque es **perfectamente inelástico** cuando los cuerpos **quedan unidos** y siguen juntos después del impacto (la bala que se incrusta, los vagones que se enganchan, los autos que quedan pegados) —ahí se pierde la mayor cantidad posible de energía cinética—, y es **parcialmente inelástico** cuando se separan pero pierden algo de energía, que es lo que ocurre en la mayoría de los choques de la vida diaria. Como el momento lineal (p = masa × velocidad) sí se conserva siempre, el caso perfectamente inelástico se calcula con m₁v₁ + m₂v₂ = (m₁+m₂)v. Ejemplo: un carro de 4 kg a 12 m/s choca con otro de 4 kg en reposo y quedan unidos → 4×12 = 48 = 8·v, así que v = 6 m/s.",
    flashcards: [
  ...
  },
  {
    ...
    note: "Muchos aparatos de uso diario funcionan con distintas ondas electromagnéticas, y el examen pide relacionar aparato con tipo de onda.\n\n**Horno de microondas** → microondas. El campo eléctrico oscilante hace girar de un lado a otro las moléculas de agua, que son polares; el roce entre ellas es lo que calienta el alimento. Dos aclaraciones contra mitos muy repetidos: **no** se usa una frecuencia «de resonancia» del agua (2.45 GHz está lejos de las resonancias del agua, y se eligió justamente para que la energía penetre unos centímetros y no se agote en la superficie), y **no** calienta «de adentro hacia afuera»: penetra unos pocos centímetros y el centro de una pieza grande se calienta por conducción, como en cualquier otro horno.\n\n**Control remoto** → luz **infrarroja**.\n**Celular, wifi, radio y televisión** → **ondas de radio** y microondas de baja potencia.\n**Radiografía médica** → **rayos X**.\n**Lámpara de bronceado o foco germicida** → **ultravioleta**.\n**Radioterapia y esterilización industrial** → **rayos gamma**.\n\nTodas forman parte del espectro electromagnético, ordenado de menor a mayor energía —y de mayor a menor longitud de onda—: ondas de radio → microondas → infrarrojo → luz visible → ultravioleta → rayos X → rayos gamma.\n\nLas tres magnitudes se relacionan por **c = λ·f**, con c = 3×10⁸ m/s la rapidez de la luz, λ la longitud de onda en metros y f la frecuencia en hertz. Despejando, **f = c/λ**: una onda de radio de 10 m de longitud tiene f = 3×10⁸ ÷ 10 = 3×10⁷ Hz = 30 MHz. Cuanto más corta la onda, más alta su frecuencia y más energía transporta.",
    flashcards: [
      { front: "¿Qué tipo de onda usa un horno de microondas para calentar alimentos?", back: "Microondas: hacen girar las moléculas de agua, que son polares, y el roce entre ellas produce el calor. No calienta «de adentro hacia afuera»: penetra unos centímetros y el resto se calienta por conducción." },
    ...
    quiz: [
      ...
      { q: "¿Qué tipo de radiación se usa en los equipos médicos para ver el interior del cuerpo (huesos)?", options: ["Rayos X", "Luz infrarroja", "Microondas"], correct: 0, explanation: "Los rayos X atraviesan la materia, pero el hueso los absorbe mucho más que el músculo o la grasa por su calcio. No es que «no pasen» por el hueso: pasan menos, y esa diferencia de absorción es la que forma la imagen." }
    ]
  },
  {
    id: "5.5.4",
  ...
  },
  {
    ...
    note: "Los organelos son estructuras dentro de la célula con funciones específicas. La **mitocondria** produce energía (ATP) mediante respiración celular; presente en células animales y vegetales. El **cloroplasto** realiza la fotosíntesis; solo está en células vegetales y algas. El **núcleo** contiene el ADN y controla la célula. El **ribosoma** sintetiza las proteínas a partir del ARN mensajero; es el único de esta lista que también tienen las bacterias. El **retículo endoplásmico** transporta materiales por la célula: el **rugoso** lleva ribosomas adheridos y trabaja con proteínas, el **liso** fabrica lípidos. El **aparato de Golgi** empaqueta, modifica y distribuye las proteínas que le llegan. El **lisosoma** digiere desechos y material celular con enzimas. La **vacuola** almacena agua, nutrientes y desechos, y es enorme en la célula vegetal. La **membrana celular** envuelve a toda célula y regula qué entra y qué sale. La **pared celular** es una cubierta rígida por fuera de la membrana que da forma fija a la célula; **la célula animal es la única de las que verás aquí que no la tiene**. En las plantas es de celulosa, en los hongos de quitina y en las bacterias de peptidoglicano: existe en los tres casos, cambia el material. Cuando el examen contrapone célula **animal** y **vegetal**, la pared es lo que distingue a la vegetal (junto con el cloroplasto y una vacuola central grande). Las células **procariotas** (bacterias) no tienen núcleo delimitado por membrana ni organelos membranosos; las **eucariotas** (animales, plantas, hongos, protistas) sí.",
    flashcards: [
    ...
    quiz: [
      { q: "¿Qué estructura le da forma rígida a la célula vegetal y no está presente en la célula animal?", options: ["Mitocondria", "Pared celular", "Núcleo"], correct: 1, explanation: "La pared celular de celulosa. Cuidado: no es exclusiva de las plantas —los hongos la tienen de quitina y las bacterias de peptidoglicano—, pero sí es lo que separa a la célula vegetal de la animal, que carece de ella." },
  ...
  },
  {
    ...
    note: "La vida se organiza en niveles, del más simple al más complejo. Antes de la célula hay tres niveles que también se preguntan: **átomo** → **molécula** (varios átomos unidos, como el agua o una proteína) → **organelo** (una estructura de la célula, como la mitocondria). De ahí en adelante: **célula** (unidad básica de vida) → **tejido** (grupo de células similares, ej. tejido muscular) → **órgano** (grupo de tejidos, ej. corazón) → **sistema de órganos** (grupo de órganos, ej. sistema digestivo) → **organismo** (un ser vivo completo). A nivel ecológico continúa: **población** (organismos de la misma especie en un área) → **comunidad** (varias poblaciones distintas en un área) → **ecosistema** (comunidad + ambiente físico) → **bioma** → **biosfera** (todo el planeta donde hay vida). Ejemplo: un conjunto de venados en un bosque es una población; junto con los árboles y otros animales del mismo lugar forman una comunidad.",
    flashcards: [
  ...
  },
  {
    ...
    note: "La respiración celular obtiene energía (ATP) a partir de la glucosa. La guía pide identificar **qué sustancias participan** en la glucólisis y en el ciclo de Krebs, así que apréndelo por entradas y salidas.\n\n**Glucólisis** — en el citoplasma, sin oxígeno.\nEntra: 1 glucosa (6 carbonos) + 2 ATP + 2 NAD⁺.\nSale: 2 piruvato (3 carbonos cada uno) + 4 ATP (ganancia neta 2) + 2 NADH.\n\n**Paso intermedio** — cada piruvato entra a la mitocondria, pierde un CO₂ y se convierte en **acetil-CoA**, generando NADH.\n\n**Ciclo de Krebs** (o del ácido cítrico) — en la matriz mitocondrial.\nEntra: acetil-CoA (2 carbonos), que se une al **oxalacetato** (4 C) y forma **citrato** (6 C).\nSale, por cada vuelta: 2 CO₂, 3 NADH, 1 FADH₂ y 1 ATP (o GTP). Como cada glucosa da 2 acetil-CoA, el ciclo gira dos veces.\n\n**Cadena transportadora de electrones** — en la membrana interna de la mitocondria. NADH y FADH₂ entregan sus electrones, el **oxígeno es el aceptor final** y se forma **agua**; aquí se produce la mayor parte del ATP.\n\nSobre el rendimiento total: durante mucho tiempo se enseñó «36-38 ATP», cifra que hoy se considera **sobreestimada**. Las estimaciones actuales dan alrededor de **30-32 ATP** por glucosa, porque transportar el ATP y el NADH a través de las membranas también cuesta energía. Si un reactivo te da como única opción 36-38, elígela; pero la cifra vigente es 30-32.",
    flashcards: [
  ...
  },
  {
    ...
    note: "Lo que define a la reproducción **sexual** es la **fusión de dos gametos** (fecundación) y la **variabilidad genética** que produce, gracias a la meiosis y a la recombinación. Lo más común es que los gametos vengan de dos individuos distintos, macho y hembra, pero eso no es la regla: hay especies **hermafroditas** —el caracol, la lombriz de tierra, la mayoría de las plantas con flor— en las que un mismo individuo produce los dos tipos de gameto, y sigue siendo reproducción sexual. Incluso la autofecundación de una planta lo es. Quédate con la fusión de gametos como criterio.\n\nEn la reproducción **asexual** participa un solo progenitor y no hay fusión de gametos: bipartición en bacterias, gemación en levaduras e hidras, esporulación en hongos y helechos, fragmentación en estrellas de mar, reproducción vegetativa por esquejes o tubérculos. La descendencia es **prácticamente idéntica** al progenitor: se le llama clon porque procede de la misma información genética, aunque nunca sea una copia perfecta —las mutaciones durante la copia del ADN introducen pequeñas diferencias, y por eso las bacterias evolucionan tan rápido y desarrollan resistencia a los antibióticos—.\n\nComparación: la sexual da variedad genética, que es una ventaja cuando el ambiente cambia, pero cuesta tiempo y energía; la asexual es rápida y no necesita pareja, ideal en ambientes estables, pero deja a la población vulnerable ante un cambio o una enfermedad nueva.",
    flashcards: [
    ...
    quiz: [
      ...
      { q: "¿Qué caracteriza a la reproducción sexual?", options: ["Un solo progenitor y descendencia idéntica", "Unión de gametos y descendencia genéticamente variada", "No requiere células sexuales"], correct: 1, explanation: "Lo definitorio es la fecundación —la unión de dos gametos— y la variabilidad genética que produce, no que haya un macho y una hembra: muchas plantas y animales hermafroditas se reproducen sexualmente y aportan los dos gametos." }
    ]
  },
  {
    id: "5.7.2",
  ...
  },
  {
    ...
    note: "El cuadro de Punnett es una tabla que predice las combinaciones genéticas posibles de la descendencia. Se escriben con **mayúscula los alelos dominantes** (A) y con **minúscula los recesivos** (a). Un individuo es **homocigoto** cuando sus dos alelos son iguales —homocigoto dominante (AA) u homocigoto recesivo (aa)— y **heterocigoto** cuando son distintos (Aa). El **genotipo** son los alelos que tiene (AA, Aa, aa); el **fenotipo**, el rasgo que se ve, y basta un alelo dominante para que se muestre.\n\nCómo se arma, paso a paso:\n1. Los dos alelos de un progenitor van arriba, uno por columna.\n2. Los dos del otro progenitor van a la izquierda, uno por fila.\n3. Cada celda se llena combinando el alelo de su fila con el de su columna, escribiendo primero la mayúscula.\n\nCruza clásica **Aa × Aa**: arriba A y a, a la izquierda A y a. Las cuatro celdas quedan AA, Aa, Aa y aa (arriba a la izquierda AA; arriba a la derecha Aa; abajo a la izquierda Aa; abajo a la derecha aa). Tienes el cuadro dibujado en los reactivos de este tema.\n\nResultado: **1 AA : 2 Aa : 1 aa** de genotipo (25 % : 50 % : 25 %) y **3:1** de fenotipo si A domina sobre a.\n\nLas otras cruzas que se preguntan:\n· **AA × aa** → 4 celdas Aa: 100 % heterocigotos, todos con el fenotipo dominante.\n· **Aa × aa** (retrocruza) → 2 Aa y 2 aa: 50 % y 50 %.\n· **AA × Aa** → 2 AA y 2 Aa: todos con fenotipo dominante.\n\nCuando el reactivo te muestre varios cuadros y pregunte cuál corresponde a un cruce, revisa primero **qué alelos hay en los encabezados** (deben ser los de los progenitores) y luego que las celdas estén bien combinadas.\n\nUn aviso que ahorra errores: los ejemplos escolares de «rasgos mendelianos» humanos —color de ojos, enrollar la lengua, tipo de cabello, lóbulo de la oreja— **no funcionan así en realidad**: dependen de muchos genes. Sirven como ejercicio de cuadro de Punnett, pero no como afirmación biológica.",
    flashcards: [
    ...
    quiz: [
      ...
      { q: "Observa el cuadro. ¿Qué cruce representa y qué proporción de genotipos produce?", figura: { tipo: "punnett", filas: ["A", "a"], cols: ["A", "a"] }, options: ["Aa × Aa, con 1 AA : 2 Aa : 1 aa", "AA × aa, con 100 % Aa", "Aa × aa, con 50 % Aa y 50 % aa"], correct: 0, explanation: "Los encabezados muestran A y a en ambos lados: los dos progenitores son heterocigotos (Aa × Aa). Las cuatro celdas dan AA, Aa, Aa y aa, es decir 1 : 2 : 1 de genotipo y 3 : 1 de fenotipo." }
    ]
  },
  {
    id: "5.7.4",
  ...
  },
  {
    ...
    note: "La guía pide tres conceptos y conviene no mezclarlos.\n\n**Evolución divergente**: de una especie ancestral común salen varias especies distintas que se adaptan a ambientes diferentes. Ejemplo: los pinzones de Darwin en las Galápagos, cada uno con un pico según su alimento. Su huella son las **estructuras homólogas**: mismo origen, distinta función (el brazo humano, el ala del murciélago y la aleta de la ballena tienen los mismos huesos).\n\n**Adaptación morfológica**: un cambio en la forma o la estructura del cuerpo que mejora la supervivencia en un ambiente. Ejemplo: el pelaje grueso y la capa de grasa del oso polar, las espinas del cactus, las patas palmeadas del pato.\n\n**Convergencia molecular**: aquí está la trampa del tema. La convergencia **morfológica** es la que todos conocen: especies no emparentadas que desarrollan formas parecidas ante presiones parecidas (las alas de ave e insecto, el cuerpo hidrodinámico del tiburón y el delfín). La convergencia **molecular** es lo mismo pero **al nivel del ADN y de las proteínas**: linajes independientes llegan por separado a la **misma solución bioquímica**, incluso a los mismos cambios en los mismos genes.\n\nEjemplos que se citan siempre:\n· **Ecolocalización** en murciélagos y delfines: los dos desarrollaron cambios idénticos en la proteína **prestina** del oído interno, pese a estar muy alejados en el árbol evolutivo.\n· **Antifreeze**: los peces del Ártico y los de la Antártida producen proteínas anticongelantes muy parecidas, evolucionadas por separado.\n· **Digestión de hojas**: monos colobinos y vacas llegaron por separado a la misma modificación de la enzima lisozima para digerir bacterias en el estómago.\n\nEn el examen: si el ejemplo habla de **forma externa** parecida (alas, aletas, cuerpo fusiforme), es convergencia morfológica; si habla de **genes, proteínas o enzimas** iguales en especies no emparentadas, es convergencia molecular.",
    flashcards: [
      ...
      { front: "¿Qué es la convergencia molecular?", back: "Cuando especies no emparentadas llegan por separado a la **misma solución bioquímica**: los mismos cambios en genes o proteínas. Ejemplo clásico: la proteína prestina de murciélagos y delfines, ambos con ecolocalización. Si el parecido es de forma externa (alas de ave e insecto), es convergencia **morfológica**." }
    ],
    quiz: [
