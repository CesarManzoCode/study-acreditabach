...
const AREA3_EXTRA = {
  ...
  "3.1.2": {
    ...
    quiz: [
      { q: "¿Cuál fue la causa principal de la Guerra de Castas en Yucatán?", options: ["El despojo de tierras comunales mayas, sumado a la carga fiscal y al trabajo forzado","Una disputa religiosa entre órdenes católicas","La negativa de los mayas a aprender español"], correct: 0, explanation: "El detonante fue un conjunto: la expansión de las haciendas —azucareras en el sur y del henequén sobre todo después— sobre las tierras comunales, las obvenciones parroquiales y los impuestos personales, el endeudamiento y el trabajo forzado, y el hecho de que los mayas habían sido armados y entrenados en las guerras entre facciones yucatecas. Reducirlo solo al henequén es inexacto: el auge henequenero llegó a su punto más alto décadas después de 1847." },
