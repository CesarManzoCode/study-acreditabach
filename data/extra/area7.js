...
const AREA7_EXTRA = {
  "7.1.1": {
    ...
    quiz: [
      ...
      { q: "Según el Coneval, la pobreza en México se mide considerando:", options: ["El ingreso y también las carencias sociales", "Únicamente el ingreso mensual", "Solo el acceso a la educación"], correct: 0, explanation: "Es una medición multidimensional: ingreso más seis carencias sociales." },
  ...
  "7.1.3": {
    flashcards: [
      { front: "¿Qué es el sector cuaternario?", back: "Una división más reciente que agrupa actividades basadas en conocimiento: investigación, desarrollo tecnológico, consultoría e innovación. Se desprende del terciario." },
  ...
  "7.1.4": {
    ...
    quiz: [
      ...
      { q: "Un coeficiente de Gini cercano a 1 indica:", options: ["Alta concentración del ingreso en pocas manos", "Distribución perfectamente equitativa", "Que no hay datos disponibles"], correct: 0, explanation: "Cuanto más se acerca a 1, mayor es la desigualdad medida." },
  ...
  "7.1.5": {
    ...
    quiz: [
      ...
      { q: "El aguinaldo es una prestación que corresponde a:", options: ["Los trabajadores con empleo formal", "Todos los trabajadores, formales e informales", "Solo a quienes tienen puestos directivos"], correct: 0, explanation: "Deriva de la relación laboral registrada conforme a la Ley Federal del Trabajo." }
    ]
  },
  ...
  "7.2.1": {
    flashcards: [
      { front: "¿Qué propuso John Locke?", back: "Que los seres humanos tienen derechos naturales a la vida, la libertad y la propiedad, y que el gobierno existe para protegerlos: si los vulnera, el pueblo puede sustituirlo." },
      { front: "¿Qué aportó Montesquieu?", back: "La división de poderes en Ejecutivo, Legislativo y Judicial, para que el poder detenga al poder y no se concentre en una sola persona." }
    ],
    quiz: [
      ...
      { q: "La idea de que el gobierno debe proteger la vida, la libertad y la propiedad, y que puede ser sustituido si no lo hace, corresponde a:", options: ["John Locke", "Thomas Hobbes", "Karl Marx"], correct: 0, explanation: "Locke influyó decisivamente en las revoluciones liberales y en las constituciones modernas." },
      { q: "La división de poderes que adopta la Constitución mexicana se inspira en:", options: ["Montesquieu", "Hobbes", "Rousseau"], correct: 0, explanation: "En 'El espíritu de las leyes' propuso separar Ejecutivo, Legislativo y Judicial para evitar la tiranía." }
    ]
  },
  ...
  "7.2.6": {
    ...
    quiz: [
      { q: "México se niega a opinar sobre un cambio de gobierno en otro país. ¿Qué principio aplica?", options: ["No intervención", "Cooperación internacional", "Igualdad jurídica de los Estados"], correct: 0, explanation: "El principio de no intervención impide inmiscuirse en los asuntos internos de otras naciones." },
  ...
  "7.2.7": {
    ...
    flashcards: [
      ...
      { front: "¿Qué son el FMI y el Banco Mundial?", back: "El **FMI** vigila la estabilidad financiera y presta a países con crisis de balanza de pagos; el **Banco Mundial** financia proyectos de desarrollo a largo plazo." }
    ],
    quiz: [
      ...
      { q: "El organismo que coordina la respuesta mundial ante una pandemia es:", options: ["La OMS", "La Unesco", "El Banco Mundial"], correct: 0, explanation: "La Organización Mundial de la Salud es la agencia sanitaria de la ONU." }
    ]
  },
  ...
  "7.3.1": {
    flashcards: [
      { front: "¿Qué es la movilidad social?", back: "El cambio de posición socioeconómica de una persona o familia entre generaciones. En México es baja: la mayoría permanece en el estrato en que nació." },
    ...
    quiz: [
      ...
      { q: "Que un hijo de padres sin estudios llegue a la universidad y a un empleo mejor pagado es un ejemplo de:", options: ["Movilidad social ascendente", "Segregación", "Estratificación rígida"], correct: 0, explanation: "Hay cambio de posición socioeconómica respecto de la generación anterior." },
  ...
  "7.3.2": {
    flashcards: [
      { front: "¿Qué mide el índice de marginación del Conapo?", back: "El grado de privación de una localidad en educación, vivienda, servicios básicos e ingresos. Clasifica de muy baja a muy alta marginación." },
  ...
  "7.3.6": {
    flashcards: [
      { front: "¿Qué consecuencias tuvo el sismo de 1985?", back: "Miles de muertos y enorme destrucción en la capital, pero también el surgimiento de una sociedad civil organizada que se anticipó a la respuesta oficial." },
      { front: "¿Qué efectos sociales dejó la pandemia de COVID-19 en México?", back: "Exceso de mortalidad, pérdida masiva de empleos sobre todo informales, rezago educativo por el cierre de escuelas y aumento de la desigualdad digital." }
    ],
    quiz: [
      ...
      { q: "La crisis de 1994-1995, conocida como 'error de diciembre', provocó:", options: ["Una fuerte devaluación del peso, quiebras y el rescate bancario del Fobaproa", "El fin del neoliberalismo", "La nacionalización del petróleo"], correct: 0, explanation: "La salida de capitales derivó en devaluación, alza de tasas y una deuda pública heredada por el rescate bancario." },
      ...
      { q: "El sismo de 1985 tuvo un efecto político porque:", options: ["La sociedad civil se organizó ante la lentitud del gobierno y ganó protagonismo", "Provocó elecciones anticipadas", "Terminó con la crisis económica"], correct: 0, explanation: "La autoorganización ciudadana mostró la capacidad de la sociedad frente al aparato estatal." }
    ]
  },
  ...
  "7.3.7": {
    ...
    quiz: [
      ...
      { q: "Las remesas que envían los migrantes mexicanos desde el extranjero:", options: ["Son una de las principales fuentes de divisas del país", "Representan un porcentaje insignificante de la economía", "Solo benefician a las grandes empresas"], correct: 0, explanation: "Superan cada año decenas de miles de millones de dólares y sostienen el ingreso de muchos hogares." },
      { q: "México es considerado un país de origen, tránsito, destino y retorno migratorio porque:", options: ["Emigran mexicanos, cruzan centroamericanos, llegan extranjeros y regresan connacionales deportados", "Solo recibe migrantes", "Solo expulsa población"], correct: 0, explanation: "Los cuatro fenómenos ocurren simultáneamente en el país." }
    ]
  },

  "7.3.8": {
    flashcards: [
      { front: "¿Qué fue el movimiento por los derechos civiles en Estados Unidos?", back: "La lucha de la población afroamericana contra la segregación racial en los años cincuenta y sesenta, con figuras como Rosa Parks y Martin Luther King." },
      { front: "¿Qué caracteriza a los nuevos movimientos sociales?", back: "Que no se organizan alrededor de la clase social, sino de identidades y causas: género, ecología, diversidad sexual, derechos indígenas o defensa del territorio." }
    ],
    quiz: [
      { q: "Un movimiento que exige a los gobiernos actuar contra el cambio climático corresponde a:", options: ["El movimiento ecologista o ambientalista", "El movimiento hippie", "El movimiento antiglobalización exclusivamente"], correct: 0, explanation: "El ambientalismo es uno de los nuevos movimientos sociales de mayor alcance mundial." },
