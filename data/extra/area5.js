...
const AREA5_EXTRA = {
  ...
  "5.1.2": {
    flashcards: [
      ...
      { front: "¿Qué es el plasma?", back: "El cuarto estado de agregación: gas ionizado con partículas cargadas libres. Está en el Sol, los rayos y los tubos de neón; es el estado más abundante del universo visible." }
    ],
    quiz: [
  ...
  "5.1.4": {
    flashcards: [
      { front: "¿Cuáles son los puntos de referencia del agua en las tres escalas?", back: "Congelación: 0 °C = 32 °F = 273 K. Ebullición: 100 °C = 212 °F = 373 K. Sirven para comprobar si un resultado tiene sentido." },
    ...
    quiz: [
      { q: "¿Qué representa el cero absoluto?", options: ["La temperatura mínima posible, 0 K o -273 °C, donde cesa el movimiento térmico", "La temperatura de congelación del agua", "El punto donde coinciden Celsius y Fahrenheit"], correct: 0, explanation: "Es el límite inferior de temperatura y el origen de la escala Kelvin; la tercera ley afirma que no es alcanzable." },
      { q: "Un termómetro marca 37 °C. ¿Cuánto es en kelvin?", options: ["310 K", "37 K", "273 K"], correct: 0, explanation: "K = °C + 273: 37 + 273 = 310 K." },
      { q: "Un aumento de 10 °C equivale, en la escala Kelvin, a un aumento de:", options: ["10 K, porque los grados tienen el mismo tamaño", "283 K", "18 K"], correct: 0, explanation: "Celsius y Kelvin usan el mismo tamaño de grado; solo cambia el punto de origen." },
  ...
  "5.1.5": {
    ...
    quiz: [
      ...
      { q: "Un globo frotado con el cabello atrae pedacitos de papel neutros. Esto ocurre porque:", options: ["El globo cargado induce una separación de cargas en el papel", "El papel también estaba cargado con el mismo signo", "La gravedad los atrae"], correct: 0, explanation: "La carga del globo polariza el papel: la cara cercana adquiere carga opuesta y aparece atracción neta." },
  ...
  "5.2.2": {
    flashcards: [
      ...
      { front: "¿Qué es el calor latente?", back: "La energía que absorbe o libera una sustancia durante un cambio de estado, sin que su temperatura cambie: se usa en romper o formar las fuerzas entre partículas." }
    ],
    quiz: [
  ...
  "5.2.3": {
    flashcards: [
      { front: "¿Qué diferencia hay entre energía renovable y no renovable?", back: "Las **renovables** se regeneran en escala humana (solar, eólica, hidráulica, geotérmica, biomasa); las **no renovables** se agotan (carbón, petróleo, gas natural, uranio)." },
      { front: "¿Qué es la energía química?", back: "La almacenada en los enlaces entre átomos. Se libera en la combustión, en las pilas y en la digestión de los alimentos." }
    ],
    quiz: [
      { q: "En una linterna encendida, ¿qué transformación de energía ocurre?", options: ["Química a eléctrica y de eléctrica a luminosa y térmica", "Nuclear a eléctrica", "Eólica a química"], correct: 0, explanation: "La pila convierte energía química en eléctrica y el foco la convierte en luz y calor." },
      { q: "¿Cuál de las siguientes NO es una fuente de energía renovable?", options: ["El gas natural", "La energía geotérmica", "La energía eólica"], correct: 0, explanation: "El gas natural es un combustible fósil: su formación tomó millones de años y se agota al usarse." },
      { q: "Una presa hidroeléctrica transforma principalmente:", options: ["Energía potencial gravitatoria del agua en energía eléctrica", "Energía nuclear en energía térmica", "Energía química en energía luminosa"], correct: 0, explanation: "El agua embalsada cae, mueve las turbinas y el generador convierte ese movimiento en electricidad." },
  ...
  "5.3.2": {
    flashcards: [
      ...
      { front: "¿Qué caracteriza al desierto como bioma?", back: "Precipitación menor a 250 mm al año, gran diferencia de temperatura entre el día y la noche, y especies adaptadas a retener agua, como los cactus." }
    ],
    quiz: [
      ...
      { q: "Los cactus tienen espinas en lugar de hojas anchas porque:", options: ["Reducen la pérdida de agua por transpiración", "Necesitan captar más luz", "Almacenan semillas"], correct: 0, explanation: "Es una adaptación al desierto: menos superficie expuesta significa menos evaporación." },
  ...
  "5.3.4": {
    flashcards: [
      { front: "¿Qué papel juegan las bacterias en el ciclo del nitrógeno?", back: "Fijan el N₂ del aire y lo convierten en compuestos que las plantas pueden absorber; otras lo nitrifican y otras lo devuelven a la atmósfera (desnitrificación)." },
      { front: "¿Qué distingue al ciclo del fósforo de los demás?", back: "Que no tiene fase gaseosa relevante: circula entre rocas, suelo, agua y seres vivos, y por eso es mucho más lento." }
    ],
    quiz: [
      ...
      { q: "El exceso de fertilizantes en un lago provoca eutrofización porque:", options: ["El exceso de nutrientes dispara el crecimiento de algas que consumen el oxígeno del agua", "Los fertilizantes envenenan directamente a los peces", "Disminuye la temperatura del agua"], correct: 0, explanation: "Al morir y descomponerse, la biomasa algal agota el oxígeno disuelto y asfixia a la fauna acuática." },
      { q: "En el ciclo del agua, el paso del vapor atmosférico a gotas líquidas se llama:", options: ["Condensación", "Evaporación", "Infiltración"], correct: 0, explanation: "La condensación forma las nubes; después la precipitación devuelve el agua a la superficie." }
    ]
  },
  ...
  "5.3.6": {
    flashcards: [
      ...
      { front: "¿Qué es el pago por servicios ambientales?", back: "Un esquema en el que se compensa económicamente a quien conserva un ecosistema, como comunidades que cuidan un bosque que capta agua para una ciudad." }
    ],
    quiz: [
      { q: "Un bosque que retiene el agua de lluvia y evita inundaciones río abajo presta un servicio:", options: ["De regulación", "De aprovisionamiento", "Cultural"], correct: 0, explanation: "No entrega un bien material: mantiene un proceso que hace habitable el entorno." },
      { q: "La polinización realizada por abejas es un servicio ambiental crucial porque:", options: ["De ella depende buena parte de la producción de alimentos", "Produce miel exclusivamente", "Regula la temperatura del planeta"], correct: 0, explanation: "Una gran proporción de los cultivos que comemos requiere polinizadores para dar fruto." },
  ...
  "5.4.2": {
    flashcards: [
      { front: "¿Qué es una reacción de sustitución simple y una de doble sustitución?", back: "**Simple**: un elemento desplaza a otro de un compuesto (A + BC → AC + B). **Doble**: dos compuestos intercambian sus partes (AB + CD → AD + CB)." },
      { front: "¿Qué diferencia hay entre reacción exotérmica y endotérmica?", back: "La **exotérmica** libera energía al entorno (combustión); la **endotérmica** la absorbe (fotosíntesis, hielo derritiéndose)." }
    ],
    quiz: [
      ...
      { q: "La combustión de la madera es una reacción:", options: ["Exotérmica, porque libera calor y luz", "Endotérmica, porque absorbe energía", "Sin intercambio de energía"], correct: 0, explanation: "Los productos tienen menos energía que los reactivos y la diferencia se libera al ambiente." },
      { q: "¿Qué evidencia indica que ocurrió una reacción química y no solo un cambio físico?", options: ["La formación de un precipitado, un gas o un cambio de color permanente", "Que la sustancia cambió de forma", "Que se disolvió en agua"], correct: 0, explanation: "Un cambio físico no altera la identidad de la sustancia; una reacción produce sustancias nuevas." }
    ]
  },
  ...
  "5.4.3": {
    ...
    quiz: [
      ...
      { q: "La ecuación E = mc² fue formulada por:", options: ["Albert Einstein", "Isaac Newton", "Marie Curie"], correct: 0, explanation: "Expresa la equivalencia entre masa y energía, base de la energía nuclear." }
    ]
  },
  ...
  "5.5.1": {
    ...
    quiz: [
      ...
      { q: "Al saltar, un atleta flexiona las rodillas al caer para:", options: ["Aumentar el tiempo de impacto y reducir la fuerza sobre sus huesos", "Aumentar su momento lineal", "Conservar la energía cinética"], correct: 0, explanation: "La misma variación de momento repartida en más tiempo implica menos fuerza." }
    ]
  },
  ...
  "5.5.4": {
    flashcards: [
      { front: "¿Qué es la velocidad terminal?", back: "La velocidad máxima que alcanza un cuerpo al caer en el aire, cuando la resistencia iguala al peso y la aceleración se vuelve cero. Por eso un paracaidista deja de acelerar." },
    ...
    quiz: [
      { q: "Un paracaidista alcanza su velocidad terminal cuando:", options: ["La resistencia del aire iguala a su peso y la aceleración se vuelve cero", "Deja de actuar la gravedad", "Su masa disminuye"], correct: 0, explanation: "Las fuerzas se equilibran, así que la velocidad deja de aumentar y se mantiene constante." },
  ...
  "5.7.2": {
    ...
    quiz: [
      ...
      { q: "El síndrome de Down se debe a:", options: ["La presencia de un cromosoma 21 extra", "La falta de un cromosoma sexual", "Una mutación en el ADN mitocondrial"], correct: 0, explanation: "Es una trisomía: en lugar de dos copias del cromosoma 21 hay tres." }
    ]
  },
  ...
  "5.7.3": {
    ...
    quiz: [
      ...
      { q: "Los grupos sanguíneos ABO son un ejemplo de:", options: ["Alelos múltiples con codominancia entre A y B", "Herencia ligada al sexo", "Dominancia incompleta"], correct: 0, explanation: "Hay tres alelos (A, B, O); A y B se expresan a la vez en el grupo AB y ambos dominan sobre O." }
    ]
  },

  "5.7.4": {
    flashcards: [
      { front: "¿Qué es la teoría sintética de la evolución?", back: "La síntesis moderna: combina la selección natural de Darwin con la genética mendeliana. Explica el origen de la variación (mutación y recombinación) que Darwin desconocía." },
      { front: "¿Qué evidencias sostienen la evolución?", back: "El registro fósil, las estructuras homólogas, los órganos vestigiales, la embriología comparada y la semejanza del ADN entre especies emparentadas." }
    ],
    quiz: [
      ...
      { q: "¿Qué aportó la genética a la teoría de la evolución?", options: ["Explicar el origen de la variación mediante mutaciones y recombinación", "Demostrar que la evolución no existe", "Confirmar las ideas de Lamarck"], correct: 0, explanation: "Darwin no conocía el mecanismo de la herencia; la genética completó su teoría en la síntesis moderna." }
    ]
  },
  ...
  "5.7.5": {
    ...
    quiz: [
      ...
      { q: "Los órganos vestigiales, como el apéndice humano, son evidencia de que:", options: ["Las especies descienden de ancestros donde esas estructuras sí eran funcionales", "Los organismos se crean con partes inútiles", "La evolución se detuvo"], correct: 0, explanation: "Son restos de estructuras que cumplían una función en el linaje del que provenimos." },
