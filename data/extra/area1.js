...
const AREA1_EXTRA = {
  ...
  "1.1.2": {
    flashcards: [
      ...
      { front: "¿Qué es un sesgo de muestreo?", back: "Un error sistemático que hace que la muestra no represente a la población, como encuestar solo por internet un tema que afecta a personas sin acceso a la red." }
    ],
    quiz: [
      { q: "Una encuesta sobre transporte público se aplica únicamente a personas que salen del estacionamiento de un centro comercial. ¿Qué problema tiene?", options: ["Sesgo de muestreo: excluye justamente a quienes usan transporte público", "Ninguno, la muestra es aleatoria", "Es un muestreo estratificado"], correct: 0, explanation: "La forma de seleccionar deja fuera sistemáticamente a la población de interés, así que el resultado no es generalizable." },
      ...
      { q: "Se echan a la urna los nombres de los 500 alumnos y se sacan 50 papeletas. ¿Qué tipo de muestreo es?", options: ["Aleatorio simple", "Sistemático", "Por conglomerados"], correct: 0, explanation: "Todos los elementos tienen la misma probabilidad de salir, sin intervalos ni grupos previos." }
    ]
  },
  ...
  "1.1.4": {
    flashcards: [
      { front: "¿Qué es el rango de un conjunto de datos?", back: "La diferencia entre el valor máximo y el mínimo. Es la medida de dispersión más simple, pero también la más sensible a un solo valor extremo." },
    ...
    quiz: [
      ...
      { q: "¿Cuál es el rango del conjunto 12, 4, 19, 7, 15?", options: ["15", "19", "11"], correct: 0, explanation: "Rango = máximo - mínimo = 19 - 4 = 15." }
    ]
  },
  ...
  "1.3.1": {
    ...
    quiz: [
      ...
      { q: "¿Cuál es el grado de la expresión 5x³ - 2x + 9?", options: ["3", "5", "9"], correct: 0, explanation: "El grado de un polinomio es el exponente más alto de la variable." }
    ]
  },
  ...
  "1.3.3": {
    flashcards: [
      ...
      { front: "Desarrollo del binomio al cubo", back: "(a + b)³ = a³ + 3a²b + 3ab² + b³. Con signo negativo, los términos alternan: (a - b)³ = a³ - 3a²b + 3ab² - b³." }
    ],
    quiz: [
  ...
  "1.4.3": {
    ...
    quiz: [
      { q: "En una escuela hay 3 mujeres por cada 2 hombres y en total 250 estudiantes. ¿Cuántas mujeres hay?", options: ["150", "125", "100"], correct: 0, explanation: "Son 5 partes iguales: 250 ÷ 5 = 50 por parte, y a las mujeres les corresponden 3 partes: 150." },
      { q: "Si 3/x = 12/20, ¿cuánto vale x?", options: ["5", "7", "80"], correct: 0, explanation: "Por productos cruzados: 3 × 20 = 12x → 60 = 12x → x = 5." },
      { q: "Una receta usa harina y azúcar en razón 4:1. Si se usan 600 g de harina, ¿cuánta azúcar corresponde?", options: ["150 g", "240 g", "2400 g"], correct: 0, explanation: "La azúcar es la cuarta parte de la harina: 600 ÷ 4 = 150 g." }
    ]
  },
  ...
  "1.5.1": {
    flashcards: [
      ...
      { front: "¿Cómo se calcula el área de una figura irregular?", back: "Se descompone en figuras conocidas (rectángulos, triángulos), se calcula cada área y se suman; o se resta el área de los huecos al total." }
    ],
    quiz: [
      { q: "Si se duplica el lado de un cuadrado, ¿qué le pasa a su área?", options: ["Se cuadruplica", "Se duplica", "Se mantiene igual"], correct: 0, explanation: "Área = lado²: al duplicar el lado, el área se multiplica por 2² = 4." },
      { q: "Se quiere cercar un terreno con malla. ¿Qué se necesita calcular?", options: ["El perímetro", "El área", "El volumen"], correct: 0, explanation: "La malla rodea el terreno, así que la medida relevante es la longitud del contorno." },
      { q: "Un terreno en forma de L se puede medir:", options: ["Dividiéndolo en dos rectángulos y sumando sus áreas", "Solo con la fórmula del círculo", "Midiendo únicamente el lado más largo"], correct: 0, explanation: "Descomponer en figuras conocidas es el método general para superficies irregulares." }
    ]
  },
  ...
  "1.5.2": {
    ...
    quiz: [
      ...
      { q: "Si la razón de semejanza entre dos figuras es 3:1, la razón entre sus volúmenes es:", options: ["27:1", "3:1", "9:1"], correct: 0, explanation: "Los lados van con k, las áreas con k² y los volúmenes con k³ = 27." },
  ...
  "1.5.4": {
    flashcards: [
      ...
      { front: "¿Cuál es el punto medio de un segmento?", back: "El promedio de las coordenadas: M = ((x₁+x₂)/2, (y₁+y₂)/2)." }
    ],
    quiz: [
      { q: "¿Cuál es la distancia entre los puntos (1, 2) y (4, 6)?", options: ["5", "7", "25"], correct: 0, explanation: "√((4-1)² + (6-2)²) = √(9 + 16) = √25 = 5." },
      { q: "¿Cuál es el punto medio del segmento que une (-2, 4) y (6, 8)?", options: ["(2, 6)", "(4, 12)", "(8, 4)"], correct: 0, explanation: "Se promedian las coordenadas: ((-2+6)/2, (4+8)/2) = (2, 6)." },
      { q: "Un cuadrilátero tiene vértices en (0,0), (5,0), (5,3) y (0,3). ¿Cuál es su perímetro?", options: ["16 unidades", "15 unidades", "8 unidades"], correct: 0, explanation: "Es un rectángulo de 5 por 3: perímetro = 2(5 + 3) = 16 unidades." }
    ]
  },
