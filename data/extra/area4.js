...
const AREA4_EXTRA = {
  ...
  "4.2.1": {
    flashcards: [
      ...
      { front: "¿Qué es la función poética?", back: "La que pone atención en la forma del mensaje: rimas, ritmo, metáforas o juegos de palabras. Predomina en la poesía y en la publicidad." },
      { front: "¿Qué es la función metalingüística?", back: "Cuando el lenguaje se usa para hablar del propio lenguaje: '¿Qué significa la palabra alteridad?'." }
    ],
    quiz: [
      { q: "El anuncio 'Del campo a tu mesa, frescura que se siente' destaca principalmente la función:", options: ["Poética", "Referencial", "Metalingüística"], correct: 0, explanation: "El cuidado del ritmo y de la imagen sensorial señala que lo importante es la forma del mensaje." },
      { q: "La frase '¿Bueno? ¿Me escuchas?' en una llamada cumple la función:", options: ["Fática", "Emotiva", "Referencial"], correct: 0, explanation: "No informa ni expresa emociones: sirve para comprobar que el canal de comunicación sigue abierto." },
      ...
      { q: "La pregunta '¿Cómo se escribe correctamente esa palabra?' corresponde a la función:", options: ["Metalingüística", "Emotiva", "Fática"], correct: 0, explanation: "El lenguaje se usa para referirse al propio código lingüístico." }
    ]
  },
  ...
  "4.3.1": {
    ...
    quiz: [
      { q: "Una persona decide no mentir nunca, aunque en un caso concreto mentir traería mejores resultados. ¿Qué postura ética refleja?", options: ["La deontológica de Kant", "El utilitarismo", "El hedonismo"], correct: 0, explanation: "Kant juzga la acción por el deber y la máxima que la guía, no por sus consecuencias." },
      ...
      { q: "Según Aristóteles, la valentía es una virtud porque:", options: ["Es el término medio entre la cobardía y la temeridad", "Consiste en no sentir miedo nunca", "Produce el mayor placer inmediato"], correct: 0, explanation: "Para Aristóteles la virtud es un justo medio entre el defecto y el exceso, alcanzado por hábito." },
  ...
  "4.3.2": {
    ...
    quiz: [
      { q: "Una escuela da apoyo adicional a los alumnos con mayor rezago para que todos alcancen el nivel esperado. Este criterio corresponde a:", options: ["La equidad", "La igualdad formal", "La tolerancia"], correct: 0, explanation: "Se distribuye distinto según la necesidad, con la finalidad de igualar las oportunidades reales." },
  ...
  "4.5.3": {
    ...
    flashcards: [
      ...
      { front: "¿Qué es el techo de cristal?", back: "La barrera invisible que limita el ascenso de las mujeres a los puestos de mayor responsabilidad, pese a tener la misma preparación." }
    ],
    quiz: [
      ...
      { q: "En una familia, la mujer trabaja tiempo completo y además se encarga sola de las labores del hogar y del cuidado. Este fenómeno se llama:", options: ["Doble jornada", "Techo de cristal", "Brecha digital"], correct: 0, explanation: "El trabajo de cuidados no remunerado se suma al empleo formal: es una carga que recae sobre todo en las mujeres." },
      { q: "Una empresa donde ninguna mujer ha llegado a la dirección pese a tener la misma preparación que sus colegas ilustra:", options: ["El techo de cristal", "La doble jornada", "Un micromachismo aislado"], correct: 0, explanation: "Es la barrera invisible que frena el ascenso de las mujeres a los puestos de decisión." },
      { q: "La perspectiva de género aplicada a las políticas públicas busca:", options: ["Identificar desigualdades entre hombres y mujeres para corregirlas en el diseño de las políticas", "Favorecer a las mujeres sobre los hombres en todos los casos", "Eliminar las diferencias biológicas"], correct: 0, explanation: "Es una herramienta de análisis: revisa cómo afecta cada política a unos y otras, y ajusta para cerrar brechas." }
    ]
  },
  ...
  "4.6.2": {
    ...
    quiz: [
      ...
      { q: "El 'círculo hermenéutico' describe que:", options: ["La comprensión del todo y la de las partes se van corrigiendo mutuamente", "Toda interpretación es circular y por eso inválida", "Un texto solo tiene una interpretación posible"], correct: 0, explanation: "No es un defecto lógico sino la forma en que efectivamente se comprende: leyendo y releyendo a la luz del conjunto." },
      { q: "Frente a la pregunta '¿qué quiso decir el autor?', la hermenéutica contemporánea añade:", options: ["Qué significa el texto para el lector situado en su propio contexto", "Cuántas palabras tiene el texto", "Quién lo publicó primero"], correct: 0, explanation: "Gadamer plantea que la comprensión es un diálogo entre el horizonte del texto y el de quien lo lee." }
    ]
  }
};
