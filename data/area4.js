const AREA4_TOPICS = [
  {
    ...
    note: "Son tres formas distintas de explicar el mundo, y lo que las separa es **cómo justifican lo que afirman**.\n\nEl **mito** explica con relatos de dioses o seres sobrenaturales; su autoridad es la tradición y no se somete a prueba. La **filosofía** razona y argumenta: pregunta por los fundamentos, define conceptos y examina críticamente los supuestos; sus preguntas —qué es la justicia, qué puedo conocer, qué hace buena una acción— no se resuelven midiendo, sino argumentando. La **ciencia** formula hipótesis sobre hechos observables y las pone a prueba con método, observación y datos.\n\nDos matices que conviene tener, porque los contrastes gruesos se caen: la ciencia **no** comprueba todo con experimentos —la astronomía, la geología o la paleontología observan y comparan sin poder experimentar—, y la filosofía **sí** somete a prueba lo que dice, solo que su prueba es la coherencia lógica y la crítica de argumentos, no el laboratorio.\n\nEn el examen: si se explica con dioses o leyendas, mito; si se argumenta racionalmente sobre fundamentos, sentido o valores, filosofía; si se contrasta con observación y datos de hechos, ciencia.",
    flashcards: [
  ...
  },
  {
    ...
    note: "El existencialismo sostiene que **cada persona es libre y responsable de darle sentido a su propia vida** mediante sus decisiones. No hay un destino ya escrito: 'la existencia precede a la esencia', primero existimos y luego, eligiendo, nos definimos.\n\nUna postura existencialista se nota cuando alguien asume la responsabilidad de sus decisiones en vez de escudarse en el destino, la suerte o «así soy yo», y busca su propio sentido aunque cause angustia. Ejemplo: alguien deja un trabajo estable para dedicarse a lo que le da sentido, aceptando la incertidumbre.\n\nMatiz importante, y no es un detalle: esa libertad **no es ilimitada**. Los propios existencialistas la llaman *situada*, y hablan de **facticidad**: el cuerpo, la época, la clase social, el país y la historia en que uno nació no se eligen. Sartre lo dice así: no somos libres de dejar de ser libres, pero elegimos siempre dentro de una situación que no pusimos nosotros. Simone de Beauvoir añade que las condiciones de opresión pueden reducir muchísimo las opciones reales de una persona. Por eso el existencialismo no es «puedes ser lo que quieras si te esfuerzas»: es «eres responsable de lo que haces con la situación que te tocó».",
    flashcards: [
  ...
  },
  {
    ...
    note: "Son dos tipos de conocimiento que distinguió la filosofía griega, y lo que los separa **no es que uno sea falso y el otro verdadero**, sino cómo se justifican.\n\nLa **doxa** es la opinión: se apoya en la apariencia, la costumbre o lo que 'se dice', y quien la sostiene no puede dar razón de por qué es así. Puede ser verdadera por casualidad y seguir siendo doxa. La **episteme** es el conocimiento fundamentado: quien lo tiene puede justificarlo, explicar sus razones y responder objeciones. Para Platón es un saber de lo estable, alcanzado por la razón; hoy solemos identificarlo con el conocimiento científico y filosófico bien fundado, pero la clave sigue siendo la **justificación**, no el mero hecho de estar comprobado en un laboratorio.\n\nEjemplo de doxa: creer que el sol 'sale' y 'se mete' porque así se ve. Ejemplo de episteme: saber, y poder explicar con el modelo astronómico, que es la Tierra la que gira.\n\nEn el examen: doxa = se afirma sin poder fundamentarlo; episteme = se afirma y se puede dar razón de ello.",
    flashcards: [
  ...
  },
  {
    ...
    note: "El **hedonismo** sostiene que el bien supremo es el placer y el mayor mal es el dolor: una acción es buena en la medida en que produce placer. Cuidado con la caricatura: en su versión clásica, la de **Epicuro**, no se trata de buscar cualquier gusto inmediato, sino de **calcular** cuáles placeres convienen y cuáles no, porque un placer momentáneo puede traer un dolor mayor. Epicuro recomendaba una vida sobria, la amistad y la ausencia de perturbación (*ataraxia*), y rechazaba los excesos precisamente porque acaban doliendo. El hedonismo de puro disfrute inmediato existe (el cirenaico, de Aristipo), pero no es el único ni el más citado. Lo que define al hedonismo no es la impulsividad: es poner el placer como criterio de lo bueno. El **estoicismo** propone alcanzar la felicidad controlando las pasiones y deseos mediante la razón, aceptando con serenidad lo que no se puede cambiar ('lo que no depende de mí no debe alterarme'). El **utilitarismo** afirma que una acción es buena si produce el mayor bienestar o felicidad para el mayor número de personas posible (el bien colectivo por encima del individual). Para identificarlos: si se prioriza el placer propio, es hedonismo; si se prioriza el autocontrol y la aceptación racional, es estoicismo; si se prioriza el beneficio de la mayoría, es utilitarismo.",
    flashcards: [
  ...
  },
  {
    ...
    note: "Las normas regulan la conducta humana y son de distintos tipos. Las **normas jurídicas** son leyes creadas por el Estado, de cumplimiento obligatorio, con sanciones legales si se incumplen (ej. no robar, pagar impuestos). Las **normas morales** provienen de la conciencia individual sobre lo bueno y lo malo; su sanción característica es **interna**: el remordimiento (ej. no mentir a un amigo). Las **normas sociales** son reglas de trato aceptadas por un grupo o cultura, y su sanción es **externa e informal**: el rechazo, la burla, la mala fama (ej. saludar, no interrumpir).\n\nOjo, porque aquí se confunden mucho: incumplir una norma moral también suele acarrear desaprobación de los demás, y eso no la convierte en norma social. Lo que las distingue no es si alguien más se entera, sino **de dónde viene la obligación**: en la moral, de la propia conciencia sobre lo bueno y lo malo, y por eso obliga aunque nadie te vea; en la social, del uso aceptado por el grupo, y por eso cambia de un lugar a otro. Para clasificar, pregúntate qué se rompe: ¿un deber de conciencia (moral), una costumbre del grupo (social), una ley del Estado (jurídica) o un mandato de fe (religiosa)? Las **normas religiosas** provienen de creencias y doctrinas de una fe, y su incumplimiento se sanciona según esa religión (ej. guardar un día de descanso religioso). Clave: identifica quién sanciona el incumplimiento para saber el tipo de norma.",
    flashcards: [
  ...
  },
  {
    ...
    note: "El discurso político es el mensaje que emiten actores públicos (candidatos, gobernantes, partidos) para **persuadir a la ciudadanía**, defender ideas, proponer soluciones o justificar decisiones de gobierno. Suele usar recursos como apelar a las emociones del público, promesas de campaña, críticas a los adversarios, y datos o cifras (a veces exagerados) para respaldar su postura. Su función principal es influir en la opinión pública y ganar apoyo o votos.\n\nTres términos que se traslapan y conviene no absolutizar: el **discurso político** es el mensaje que argumenta sobre el poder y los asuntos públicos; la **propaganda** busca difundir y hacer adherir a una ideología o causa; la **publicidad política** es el formato pagado y breve —el spot, el espectacular, el anuncio en redes— con el que se difunde ese mensaje en campaña. No son compartimentos estancos: un spot de campaña es publicidad política, hace propaganda y contiene discurso político al mismo tiempo. Lo que cambia es el ángulo desde el que se le mire: el argumento, la finalidad ideológica o el soporte pagado.\n\nEn el examen, identifica un discurso político por su intención de convencer sobre temas de gobierno, propuestas de campaña o defensa de una gestión pública, dirigido a la ciudadanía.",
    flashcards: [
  ...
  },
  {
    ...
    note: "La hermenéutica es la **disciplina o el arte de interpretar textos y símbolos** para comprender su sentido, más allá de lo literal. Se aplica a obras literarias, textos religiosos, leyes o cualquier mensaje cuyo significado dependa del contexto.\n\nDos precisiones que evitan una confusión frecuente. Primera: interpretar **no es adivinar una intención escondida** del autor. La hermenéutica clásica (Schleiermacher, Dilthey) sí ponía la meta en reconstruir lo que el autor quiso decir; la hermenéutica del siglo XX, sobre todo con **Gadamer**, sostiene que comprender es un encuentro entre el horizonte del texto y el de quien lo lee, y que un texto puede significar cosas que su autor no previó. Segunda: la interpretación es circular —el **círculo hermenéutico**—: se entiende el todo desde las partes y las partes desde el todo, en un ir y venir.\n\nPara el examen basta con la definición: si la pregunta habla de 'interpretar y comprender el sentido de un texto o símbolo en su contexto', la respuesta es hermenéutica.",
    flashcards: [
