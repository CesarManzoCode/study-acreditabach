const AREA6_EN_TOPICS = [
  ...
  },
  {
    ...
    note: "El pasado perfecto sitúa una acción **antes de otro momento del pasado** que ya está establecido en el contexto. Fórmula: **sujeto + had + participio pasado**; 'had' no cambia con ningún sujeto.\n\nEjemplos: 'When I arrived, the train had already left.' (Primero salió el tren; después llegué yo.) 'She had studied English before she moved to Canada.'\n\nDos precisiones útiles:\n\n1) El pasado perfecto marca lo anterior **respecto de un punto de referencia pasado**, no «lo más antiguo del relato» sin más. Si la oración no establece antes ese punto de referencia, no se usa pasado perfecto: para contar hechos en el orden en que sucedieron basta el pasado simple ('I woke up, had breakfast and left').\n\n2) Con **before** y **after** el orden ya queda claro por la conjunción, así que el pasado simple también es correcto: 'She studied English before she moved to Canada' es una oración válida. El pasado perfecto solo refuerza la anterioridad.\n\nSeñales que el examen suele poner para pedir pasado perfecto: **by + año o momento** ('By 1519, he had adopted…'), **already, never, just** dentro de una narración en pasado, y **when + oración en pasado simple** donde lo otro ya había ocurrido.",
    flashcards: [
  ...
  },
  {
    ...
    note: "Para comparar dos cosas se usa el **comparativo**; para tres o más, el **superlativo**.\n\n**Adjetivos de una sílaba** → -er / the -est: tall → taller than / the tallest. (big → bigger, nice → nicer.)\n\n**Adjetivos de dos sílabas** → aquí está el matiz que se suele enseñar mal. **No todos** usan *more*. Van con -er/-est los terminados en **-y** (happy → happier), y también los terminados en **-er, -ow, -le** y varios más: narrow → narrower, simple → simpler, clever → cleverer, quiet → quieter, gentle → gentler. Con *more* van los terminados en **-ful, -less, -ing, -ed** y la mayoría del resto: careful → more careful, boring → more boring, crowded → more crowded, famous → more famous. Algunos admiten las dos formas (common → commoner / more common).\n\n**Adjetivos de tres sílabas o más** → siempre *more / the most*: interesting → more interesting, expensive → the most expensive.\n\n**Irregulares** (hay que memorizarlos): good → better → the best; bad → worse → the worst; far → farther/further → the farthest/furthest; little → less → the least; much/many → more → the most.\n\n**Igualdad**: as + adjetivo + as. 'My house is as expensive as yours.'\n\nRegla práctica para el examen: una sílaba, -er; tres o más, more; con dos sílabas, si termina en -y usa -er, y si termina en -ful, -less, -ing o -ed usa more.",
    flashcards: [
  ...
  },
  {
    ...
    note: "El primer condicional se usa para situaciones reales o posibles en el futuro. Fórmula: If + presente simple, will + verbo base. El segundo condicional se usa para situaciones hipotéticas o poco probables en el presente/futuro. Fórmula: If + pasado simple, would + verbo base (con el verbo 'be' se usa 'were' para todas las personas). Ejemplo primer condicional: 'If it rains, I will stay home.' (Si llueve, me quedaré en casa; es posible). Ejemplo segundo condicional: 'If I had more money, I would buy a new car.' (Si tuviera más dinero, compraría un auto nuevo; es hipotético). Antes que esos dos está el **condicional cero**, para verdades generales que siempre se cumplen. Fórmula: If + presente simple, presente simple. Ejemplo: 'If you heat ice, it melts.' (Si calientas hielo, se derrite). Cómo distinguirlos de un vistazo: sin 'will' ni 'would' y todo en presente es condicional cero; con 'will' es el primero; con pasado y 'would' es el segundo.",
    flashcards: [
